...
EVAL = {
    ...
    "modelParams": {"halfLife": 6.0, "offSeason": 0.5, "seasonBoost": 0.2,
                    "posWeights": [1.0, 0.85, 0.72], "temperature": 1.0},
    "ladder": [
        {"model": "recent-frequency", "n": 159, "top1": 0.13, "top3": 0.27, "top5": 0.37, "logLoss": 4.31},
        {"model": "current (product)", "n": 159, "top1": 0.13, "top3": 0.28, "top5": 0.40, "logLoss": 4.20},
        {"model": "PL + tuned (chosen)", "n": 159, "top1": 0.13, "top3": 0.30, "top5": 0.42, "logLoss": 4.08},
    ],
    "chosen": {"n": 159, "top1": 0.126, "top3": 0.296, "top5": 0.415, "logLoss": 4.081,
               "brierNew": 0.239, "baseRateNew": 0.409, "brierNewBaseRate": 0.242, "ece": 0.086},
    "calibration": [
