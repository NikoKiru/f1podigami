...
### Improvements
- Mobile nav is now a burger-button drawer that slides in from the left (pure-CSS core so it works without JS, with keyboard/aria/scroll-lock enhancements), replacing the cramped horizontal scroll strip (#PR)
