...
[![Tests](https://img.shields.io/badge/tests-850%20passing-brightgreen?style=flat-square&logo=pytest&logoColor=white)](tests/)
...
tests/          pytest suite (850 tests, run in CI)
```
...
pytest --cov                          # 850 tests + coverage gate (≥70%)
```
...
| `src/build/_rows.py` | Shared ranked table (Overdue / Unlikeliest / Soulmates), mirroring the combinations table: section heading, framed container, column labels, expandable rows |
